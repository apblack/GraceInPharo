...
class new {
    var elems := 0
    var inner := intrinsic.primitiveArray.new(4)
    for (0..(inner.size-1)) do {i->
        inner.at(i)put(unused)
    }
    intrinsic.native "js" code ‹this.data.inner = { };›  
        // override the primitiveArray with an empty object

    method size {
        // The number of bindings that I contain.
        intrinsic.native "js" code ‹var s = Object.keys(this.data.inner).length;
    ...
    method put(k, v) {
        ...
        intrinsic.native "js" code ‹this.data.inner[var_k._value] = var_v;
                        return this;›
    ...
    method get(k) {
        ...
        intrinsic.native "js" code ‹if (this.data.inner.hasOwnProperty(var_k._value))
    ...
    method asString {
        intrinsic.native "js" code ‹var s = "";
